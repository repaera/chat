...
export default {
  ...
  system: {
    persona: (name: string) =>
      `Eres un asistente personal de IA para ${name}.`,
    helpWithTools:
  ...
  ui: {
    ...
    register: {
      ...
      cardTitle: "Registro",
      cardDescription: "Completa los detalles a continuación para crear tu cuenta",
      ...
      errors: {
        ...
        passwordTooWeak: "Contraseña muy débil. Agrega mayúsculas, números o símbolos.",
    ...
    settings: {
      ...
      backLink: "Atrás",
      retentionNotice: "Las conversaciones inactivas por más de {days} días se eliminarán automáticamente junto con todos los mensajes e imágenes adjuntas.",
      tabProfile: "Perfil",
      ...
      profileCard: {
        ...
        localeHint: "Determina el idioma de respuesta de la IA. Vacío = usar detección automática.",
      ...
      linksCard: {
        ...
        description: "Conecta tus cuentas de mensajería para chatear con tu asistente de IA en otras plataformas.",
        ...
        unlinkConfirmDescription: "Tu historial de conversaciones se conservará pero se eliminará el vínculo de la cuenta.",
    ...
    chatClient: {
      ...
      suggestions: ["¿Con qué puedes ayudarme?", "¿Qué herramientas tienes?", "Cuéntame algo interesante"],
      ...
      toasts: {
        ...
        geolocationFailed: "Error al obtener la ubicación. Asegúrate de tener el permiso habilitado.",
        weeklyLimitReached: "Has alcanzado tu límite de mensajes semanales. Inténtalo la próxima semana.",
      },
    ...
    forgotPassword: {
      ...
      pageSubtitleDefault: "Ingresa tu correo y te enviaremos un enlace de restablecimiento.",
      pageSubtitleSent: "Si tu correo está registrado, se ha enviado un enlace de restablecimiento.",
    ...
    verifyEmail: {
      ...
      description: "Enviamos un enlace de verificación a tu correo. Haz clic en él para activar tu cuenta.",
