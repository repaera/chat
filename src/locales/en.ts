  ...
  ui: {
    ...
    settings: {
      ...
      linksCard: {
        ...
        description: "Connect your messaging accounts to chat with your AI assistant on other platforms.",
        ...
        unlinkConfirmDescription: "Your conversation history will be kept but the account link will be removed.",
