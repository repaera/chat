...
export function resolveModel() {
  const provider = (process.env.LLM_PROVIDER as Provider | undefined) ?? detectProvider();
  ...
  switch (provider) {
    ...
    case "bedrock": {
      ...
      return bedrock(process.env.BEDROCK_MODEL ?? "anthropic.claude-3-5-haiku-20241022-v1:0");
    }
