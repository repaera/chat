# How to contribute to Chat

Chat uses GitHub
[discussions](https://github.com/repaera/chat/discussions) to track
feature requests and questions, rather than [the issue
tracker](https://github.com/repaera/chat/issues). If you're considering
